...
typedef GPB_ENUM(ProtoMessage_Type) {
  ...
  ProtoMessage_Type_LoginResponse = 2,
  ProtoMessage_Type_ChatResponse = 3,
  ProtoMessage_Type_JoinGroupNotify = 4,
  ProtoMessage_Type_QuitGroupNotify = 5,
  ProtoMessage_Type_SomeoneJoinNotify = 6,
